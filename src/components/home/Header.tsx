...
const Header = () => {
  ...
  return (
    <nav className={`w-full transition-all ease-in-out duration-1000 ${scrolled && "fixed top-0 z-[1000] justify-between px-12"} bg-[#101D26] flex ${!scrolled && "justify-center"} py-2`}>
      ...
      <Link href='/discourses' passHref>
        <button className={`${!scrolled && "hidden"} bg-lightBlue text-[#101D26] rounded-[89px] px-2 text-[10px] font-bold`}>
