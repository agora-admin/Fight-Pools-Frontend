                ...
                <div className='w-full min-h-screen flex flex-col py-10 gap-4 z-10'>
                    ...
                    <div className="flex flex-col gap-4 mt-10 grow mx-20">
                        ...
                        <div className="relative bg-card w-full flex flex-col p-8 rounded-2xl">
                            <h3 className="text-primary/70 text-xl font-semibold">Link Accounts</h3>
                            {<p className="text-[#c6c6c6] text-xs w-[50%] my-4">Link you wallet address and twitter account for a better experience with Fight Pools</p>}
                            ...
                            {loggedIn && <div className='cursor-default py-2 flex items-center w-max gap-2 text-[#616162] text-sm font-semibold'>
                                ...
                                <div className="flex flex-col justify-center">
                                    <p className='text-primary text-xs'>{shortAddress(walletAddress === "" ? '' : walletAddress)}</p>
                                </div>
                            </div>}
