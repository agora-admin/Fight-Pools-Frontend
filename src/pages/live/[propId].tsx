                ...
                <BDecoration />
                {
                    meetEnded && <div className=' justify-center overflow-hidden w-full max-w-6xl flex gap-4 z-10 t-all'>
                        <div className="bg-card p-4 w-full max-w-sm rounded-xl flex flex-col items-center gap-2">
                            <CalendarDoneIcon />
                            <p className="text-primary font-Lexend text-sm">Thanks for joining!</p>
                            <Link href={`/`}>
                    ...
                    {!isConnected && !tokenError && dData &&
                        <div className="flex flex-col gap-4 mt-10 grow mx-20">
                            ...
                            <div className="relative bg-card max-w-md mx-auto w-full flex flex-col items-center p-8 rounded-2xl">
                                ...
                                <h3 className="text-primary/70 text-center font-Lexend">Join Discourse</h3>
                                {/* { !isSpeakerWallet(dData, user.walletAddress) && <div className="flex flex-col p-4 my-2 rounded-xl z-10 w-max border border-[#212427]">
                                    ...
                                    <div className='flex items-center gap-1 mt-2'>
                                        ...
                                        <div className='flex flex-col'>
                                            <a href="#" className='hover:text-primary/60 text-[#c6c6c6] font-Lexend text-xs uppercase tracking-wide font-medium'>{dData.getDiscourseById.speakers[0].name}</a>
                                            <a href="#" className='hover:text-primary/60 text-[#c6c6c6] font-Lexend text-xs uppercase tracking-wide font-medium'>{dData.getDiscourseById.speakers[1].name}</a>
                                        </div>
                                    </div>
                                </div> 
                                } */}
                                    ...
                                    <div className="flex flex-col items-center gap-2 py-4">
                                        ...
                                        <div className="w-[60%] aspect-square relative rounded-xl overflow-clip">
                                            ...
                                            <div className="z-10 absolute bg-[#141515] inset-x-2 p-2 bottom-2 rounded-xl flex items-center justify-between">
                                                ...
                                                <p className="text-primary text-[10px] hidden sm:block sm:text-sm font-Lexend ">{shortAddress(walletAddress)}</p>
                                ...
                                {   !discourseLocked && <div className="flex flex-col items-center gap-2 py-4">
                                        ...
                                        <p className="text-primary text-sm font-Lexend ">{shortAddress(walletAddress)}</p>

                                    </div>}
                                {   discourseLocked && <div className="flex flex-col items-center gap-2 py-4">

                                        <p className="text-primary text-sm font-Lexend ">This discourse has ended.</p>
                            ...
                            <div className="w-full bg-card max-w-md mx-auto rounded-xl p-4 flex-col flex gap-2">
                                <p className="text-sm font-Lexend text-primary">{dData.getDiscourseById.title}</p>
